...
import 'package:grocery_ecommerce/view/ProductView/widgets/product_carousel_slider.dart';
            ...
            Padding(
              ...
              child: Text(
                widget.product.tags.isNotEmpty
                    ...
                    : 'No price available', // Fallback text if tags is empty
                style: TextStyle(
                  fontSize: 18,
                  color: Theme.of(context).primaryColor,
                      ...
                      children: [
                        ...
                        Text(
                          widget.product.tags.isNotEmpty
                              ...
                              : 'No tags', // Fallback text if tags is empty
                          style: TextStyle(
                            fontSize: 18,
                            color: Colors.grey.shade800,
                          ),
